...
|word / sentence vectors| 1.3 | [scikit-learn](https://scikit-learn.org/stable/modules/feature_extraction.html#text-feature-extraction) <br> [spaCy](https://spacy.io/) <br> [keras](https://keras.io) | [notebook](notebooks/nlp_1-3_word_vectors.ipynb)| [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/drive/1s6OUP_yCXNuS5RfR0wem1KeRQPhqMVif?usp=sharing)|
